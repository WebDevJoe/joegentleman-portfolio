...
import { PvBand } from "./site/PvHatch";
...
export function SiteGate() {
  ...
  return (
    <div className="pv-root fixed inset-0 z-[60] flex items-center justify-center overflow-y-auto bg-pv-bg px-4 py-10">
      {/* The same light the pages carry, so the gate sits on the site's ground
          rather than a flat black plate. */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0"
        style={{
          backgroundImage:
            "radial-gradient(120% 80% at 50% 40%, rgba(251,251,251,0.07) 0%, rgba(251,251,251,0) 70%)",
        }}
      />
      ...
      >
        ...
        <form
          ...
          className="flex flex-col gap-6 border-x border-pv-border px-6 py-8"
        >
