...
export function ChipPill({
  ...
  return (
    <button
      type="button"
      className={`inline-flex h-[40px] shrink-0 items-center justify-center whitespace-nowrap rounded-[12px] bg-[#e3e3e3] px-3 font-medium text-[16px] leading-[0.9] text-ink shadow-[0_0_0_1px_rgba(13,13,13,0.16),0_2px_4px_0_rgba(0,0,0,0.1)] cursor-pointer hover:brightness-95 transition-[filter] duration-150 ${className}`}
      {...rest}
    >
      {children}
    </button>
